...
import { Popover, Input, Checkbox, Divider, Button } from 'antd'
import { PlusOutlined, MinusOutlined } from '@ant-design/icons'
import { TooltipPlacement } from 'antd/lib/tooltip'
import { groupArrayBy, GroupArrayItem } from '../utils'

export const GroupTagSearchableSelect: SFC<{
  title: string,
  value: any[],
      ...
      <div className="tag-container">
        {value.map((item, i) => (
          <div key={i} className="tag">
            {item.name}
            <MinusOutlined onClick={() => checkChangeHandler(item)} />
          </div>
        ))}
      </div>
